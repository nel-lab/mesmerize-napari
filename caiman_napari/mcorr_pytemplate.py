...
class Ui_MCORRWidget(object):
    def setupUi(self, MCORRWidget):
        ...
        MCORRWidget.setAllowedAreas(QtCore.Qt.NoDockWidgetArea)
        ...
        MCORRWidget.setTabOrder(self.btnAddToBatchElastic, self.comboBoxProjectionsOption)
        MCORRWidget.setTabOrder(self.comboBoxProjectionsOption, self.pushButtonViewProjections)
...
"Use single quotes for strings, do not use double quotes."))
        ...
        self.label_2.setToolTip(_translate("MCORRWidget", "View Mean, Max or Std projections of the outputs from selected batch items"))
        self.label_2.setText(_translate("MCORRWidget", "View projections of selected outputs"))
        self.comboBoxProjectionsOption.setToolTip(_translate("MCORRWidget", "View Mean, Max or Std projections of the outputs from selected batch items"))
        self.comboBoxProjectionsOption.setItemText(0, _translate("MCORRWidget", "mean"))
        self.comboBoxProjectionsOption.setItemText(1, _translate("MCORRWidget", "max"))
        self.comboBoxProjectionsOption.setItemText(2, _translate("MCORRWidget", "std"))
        self.pushButtonViewProjections.setToolTip(_translate("MCORRWidget", "View Mean, Max or Std projections of the outputs from selected batch items"))
        self.pushButtonViewProjections.setText(_translate("MCORRWidget", "View"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    MCORRWidget = QtWidgets.QDockWidget()
    ui = Ui_MCORRWidget()
    ui.setupUi(MCORRWidget)
    MCORRWidget.show()
    sys.exit(app.exec_())
