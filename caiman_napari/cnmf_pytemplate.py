...
# Form implementation generated from reading ui file './ui_files/cnmf_template_dockwidget.ui'
#
...
class Ui_CNMFDockWidget(object):
    def setupUi(self, CNMFDockWidget):
        CNMFDockWidget.setObjectName("CNMFDockWidget")
        CNMFDockWidget.resize(821, 617)
        CNMFDockWidget.setFloating(True)
        CNMFDockWidget.setAllowedAreas(QtCore.Qt.RightDockWidgetArea)
        ...
        CNMFDockWidget.setWidget(self.dockWidgetContents)

        self.retranslateUi(CNMFDockWidget)
        QtCore.QMetaObject.connectSlotsByName(CNMFDockWidget)
...
"Use single quotes for strings, do not use double quotes"))
        ...
        self.btnAddToBatchCNMF.setText(_translate("CNMFDockWidget", "Add to batch"))
