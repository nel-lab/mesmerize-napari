...
class Ui_VizualizationWidget(object):
    def setupUi(self, VizualizationWidget):
        ...
        self.widget = QtWidgets.QWidget(VizualizationWidget)
        self.widget.setGeometry(QtCore.QRect(10, 30, 232, 90))
        self.widget.setObjectName("widget")
        self.gridLayout = QtWidgets.QGridLayout(self.widget)
        self.gridLayout.setContentsMargins(0, 0, 0, 0)
        self.gridLayout.setObjectName("gridLayout")
        self.comboBoxProjection = QtWidgets.QComboBox(self.widget)
        ...
        self.pushButtonViewProjection = QtWidgets.QPushButton(self.widget)
        ...
        self.pushButtonInputMovie = QtWidgets.QPushButton(self.widget)
        self.pushButtonInputMovie.setObjectName("pushButtonInputMovie")
        self.gridLayout.addWidget(self.pushButtonInputMovie, 1, 0, 1, 1)
        self.pushButtonCnImage = QtWidgets.QPushButton(self.widget)
        self.pushButtonCnImage.setObjectName("pushButtonCnImage")
        self.gridLayout.addWidget(self.pushButtonCnImage, 1, 1, 1, 2)
        self.pushButtonSubsampleMCMovie = QtWidgets.QPushButton(self.widget)
        self.pushButtonSubsampleMCMovie.setObjectName("pushButtonSubsampleMCMovie")
        self.gridLayout.addWidget(self.pushButtonSubsampleMCMovie, 2, 0, 1, 2)
        self.spinBoxSubsampleRatio = QtWidgets.QSpinBox(self.widget)
    ...
    def retranslateUi(self, VizualizationWidget):
        ...
        self.pushButtonSubsampleMCMovie.setText(_translate("VizualizationWidget", "Subsampled MC Movie"))
