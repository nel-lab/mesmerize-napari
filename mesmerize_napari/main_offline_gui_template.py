...
class Ui_MainOfflineGUIWidget(object):
    def setupUi(self, MainOfflineGUIWidget):
        ...
        self.comboBoxRecentInputMovies = QtWidgets.QComboBox(self.page_3)
        self.comboBoxRecentInputMovies.setObjectName("comboBoxRecentInputMovies")
        self.verticalLayout_5.addWidget(self.comboBoxRecentInputMovies)
        ...
        self.pushButtonViewDownsampledMCorrrMovie = QtWidgets.QPushButton(self.tab_visualize)
        self.pushButtonViewDownsampledMCorrrMovie.setObjectName("pushButtonViewDownsampledMCorrrMovie")
        self.gridLayout.addWidget(self.pushButtonViewDownsampledMCorrrMovie, 1, 0, 1, 1)
        self.spinBoxDownsampleWindow = QtWidgets.QSpinBox(self.tab_visualize)
        self.spinBoxDownsampleWindow.setMinimum(1)
        self.spinBoxDownsampleWindow.setProperty("value", 4)
        self.spinBoxDownsampleWindow.setObjectName("spinBoxDownsampleWindow")
        self.gridLayout.addWidget(self.spinBoxDownsampleWindow, 1, 1, 1, 1)
        ...
        MainOfflineGUIWidget.setTabOrder(self.pushButtonNewBatch, self.pushButtonOpenMovie)
        MainOfflineGUIWidget.setTabOrder(self.pushButtonOpenMovie, self.comboBoxRecentInputMovies)
        MainOfflineGUIWidget.setTabOrder(self.comboBoxRecentInputMovies, self.pushButtonParamsMCorr)
        ...
        MainOfflineGUIWidget.setTabOrder(self.pushButtonVizCorrelationImage, self.pushButtonViewDownsampledMCorrrMovie)
        MainOfflineGUIWidget.setTabOrder(self.pushButtonViewDownsampledMCorrrMovie, self.spinBoxDownsampleWindow)
        MainOfflineGUIWidget.setTabOrder(self.spinBoxDownsampleWindow, self.pushButtonViewMCShifts)
        MainOfflineGUIWidget.setTabOrder(self.pushButtonViewMCShifts, self.pushButtonVizReconstructedMovie)
        MainOfflineGUIWidget.setTabOrder(self.pushButtonVizReconstructedMovie, self.radioButtonROIMask)
        MainOfflineGUIWidget.setTabOrder(self.radioButtonROIMask, self.radioButtonROIOutline)
    ...
    def retranslateUi(self, MainOfflineGUIWidget):
        ...
        self.label_4.setText(_translate("MainOfflineGUIWidget", "Recent Input Movies"))
        ...
        self.pushButtonViewDownsampledMCorrrMovie.setText(_translate("MainOfflineGUIWidget", "Downsample MCorr Movie:"))
