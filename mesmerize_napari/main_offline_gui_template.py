...
class Ui_MainOfflineGUIWidget(object):
    def setupUi(self, MainOfflineGUIWidget):
        ...
        MainOfflineGUIWidget.setTabOrder(self.pushButtonVizCorrelationImage, self.pushButtonVizDownsampledMCorrrMovie)
        MainOfflineGUIWidget.setTabOrder(self.pushButtonVizDownsampledMCorrrMovie, self.pushButtonVizReconstructedMovie)
