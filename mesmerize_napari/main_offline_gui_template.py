...
class Ui_MainOfflineGUIWidget(object):
    def setupUi(self, MainOfflineGUIWidget):
        ...
        self.gridLayout.addWidget(self.pushButtonVizDownsampledMCorrrMovie, 1, 0, 1, 1)
        self.spinBox = QtWidgets.QSpinBox(self.tab_visualize)
    ...
    def retranslateUi(self, MainOfflineGUIWidget):
        ...
        self.pushButtonVizDownsampledMCorrrMovie.setText(_translate("MainOfflineGUIWidget", "Downsample MCorr Movie:"))
